...
export const SCHEMA_SQL = `
  ...
  CREATE INDEX IF NOT EXISTS idx_generations_created ON image_generations(created_at DESC);
  CREATE INDEX IF NOT EXISTS idx_generated_images_gen ON generated_images(generation_id);
`;
